...
namespace Tyuiu.YachmenevaPV.Sprint6.Task7.V13.Test
{
    [TestClass]
    public sealed class DataServiceTest
    {
        ...
        public void TestMethod1()
        {
            ...
            string path = @"C:\DataSprint6\InPutDataFileTask7V13.csv";
        ...
        public void File()
        {
            string openedFile = @"C:\DataSprint6\InPutDataFileTask7V13.csv";
